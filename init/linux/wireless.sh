...
# TODO: limit dmesg output to first 60.0 s of boot. Otherwise, the output is
# flooded with wlan connect/disconnect kernel messages if you run it on a system
# that has had a wireless inteface running for a while
cat <<EOF >${wlan} 
